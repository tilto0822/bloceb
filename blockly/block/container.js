...
export default function setContainerBlocks() {
    let container_mutator = {
        ...
        decompose: function (workspace) {
            ...
            topBlock
                ...
                .connect(tempBlock.getConnections_()[0]);
            return topBlock;
        },
        compose: function (containerBlock) {
            console.log('compose');
            let innerBlocks = Blockly.JavaScript.statementToCode(
                containerBlock,
                'container_class'
            )
                .trim()
    ...
    Blockly.Blocks['container'] = {
        init: function () {
            ...
            this.appendDummyInput()
                .appendField('Class : ')
                .appendField(
                    new Blockly.FieldTextInput('container'),
                    'containerClass'
                );
    ...
    Blockly.Blocks['widget_container'] = {
        init: function () {
            ...
            this.appendStatementInput('container_class').setCheck(
                'container_parameter'
            );
            this.setColour(120);
            this.setTooltip('');
    ...
    Blockly.Blocks['container_w_css'] = {
        init: function () {
            this.appendDummyInput().appendField('Css');
            this.setPreviousStatement(true, 'container_parameter');
            this.setNextStatement(true, 'container_parameter');
            this.setColour(330);
            this.setTooltip('');
    ...
    Blockly.JavaScript['container'] = function (block) {
        ...
        let value_css = Blockly.JavaScript.valueToCode(
            block,
            'css',
    ...
    Blockly.Extensions.registerMutator(
        ...
        container_mutator,
        null,
        ['container_w_class', 'container_w_css']
    );
}
